    ...
    <section className="cart min-h-screen p-4 bg-gray-50">
      ...
      {cart.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {cart.map((item) => (
            <div key={item.id} className="border rounded-lg shadow-lg p-4 bg-white relative">
              <button 
              ...
              <img src={item.imageSrc} alt={item.title} className="w-full h-48 object-cover mb-4 rounded" />
